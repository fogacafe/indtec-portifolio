...
export default function App() {
  ...
  return (
    <div className="site-shell">
      ...
      <main id="top">
        <section className="hero" id="profile"><div className="hero-grid" aria-hidden="true" /><div className="hero-kicker"><span>{t.heroKicker}</span><span>BR / 2026</span></div><div className="hero-copy"><p className="mono eyebrow">{t.heroEyebrow}</p><h1>{t.heroTitle}<span>{t.heroTitleMuted}</span></h1><p className="hero-description">{t.heroDescription}</p></div><div className="hero-footer"><div className="hero-stack mono"><span>.NET</span><i /><span>AWS</span><i /><span>DISTRIBUTED SYSTEMS</span></div><a className="explore-link" href="#experience">{t.explore} <ArrowDown size={16} /></a></div></section>
